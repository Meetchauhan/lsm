...
import { AdminRegisterSchema } from "../../../validationSchema/ValidationSchema";
import { adminRegister } from "../../../features/registerSlice";
...
const AdminRegister = () => {
  ...
  const { values, errors, touched, handleChange, handleSubmit } = useFormik({
    ...
    onSubmit: async (value, action) => {
      await dispatch(adminRegister(value));
  ...
  return (
    <div className="min-h-[100vh] flex items-center p-6 ">
      <Card className="max-w-lg mx-auto w-full">
        <h2 className="text-3xl text-center mb-3">Admin Register</h2>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div>
            <div className="mb-2 block">
              <Label htmlFor="lastName" value="Last Name" className="text-lg" />
            </div>
            <TextInput
              id="lName"
              type="text"
